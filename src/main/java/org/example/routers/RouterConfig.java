...
//        return route(GET("/handlers/users").and(accept(MediaType.APPLICATION_JSON)), handler::getAllUsers)
...
//                .andRoute(DELETE("/handler/users/{userId}").and(contentType(MediaType.APPLICATION_JSON)), handler::deleteUserById);
//    }
//}
